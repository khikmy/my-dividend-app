...
def render_dividend_form():
    ...
    with st.form("dividend_entry_form", clear_on_submit=not is_edit):
        ...
        with col1:
            ...
            year = st.number_input("配当金受取年", value=int(ed.get("year", 2026))) # デフォルトを2026年に修正
